...
namespace UILHost.Patterns.Repository.EF6
{
    public class Repository<TEntity> : IRepositoryAsync<TEntity> where TEntity : Entity
    {
        ...
        // JTH - Added _context.SyncObjectStatePostCommit for insertGraph and insertGraphRange

        public virtual void InsertGraph(TEntity entity) { _dbSet.Add(entity); _context.SyncObjectsStatePostCommit(); }

        public virtual void InsertGraphRange(IEnumerable<TEntity> entities) { _dbSet.AddRange(entities); _context.SyncObjectsStatePostCommit(); }
