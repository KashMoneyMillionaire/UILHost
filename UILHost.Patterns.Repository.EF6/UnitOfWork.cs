...
namespace UILHost.Patterns.Repository.EF6
{
    public class UnitOfWork : IUnitOfWorkAsync
    {
        ...
        public virtual int SaveChanges() { return _dataContext.SaveChanges(); }

        public virtual IRepository<TEntity> Repository<TEntity>() where TEntity : IObjectState { return RepositoryAsync<TEntity>(); }

        public virtual Task<int> SaveChangesAsync() { return _dataContext.SaveChangesAsync(); }

        public virtual Task<int> SaveChangesAsync(CancellationToken cancellationToken) { return _dataContext.SaveChangesAsync(cancellationToken); }

        public virtual IRepositoryAsync<TEntity> RepositoryAsync<TEntity>() where TEntity : IObjectState
        {
