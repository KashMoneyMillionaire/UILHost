...
namespace UILHost.Web.Controllers
{
    public partial class AccountController
    {
        ...
        {
            public readonly string returnUrl = "returnUrl";
            public readonly string addContext = "addContext";
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : UILHost.Web.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, UILHost.Web.Models.LoginViewModel model, string returnUrl);

        [NonAction]
        public override System.Web.Mvc.ActionResult Login(UILHost.Web.Models.LoginViewModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        [NonAction]
        partial void RedirectToLocalOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string returnUrl, bool addContext);

        [NonAction]
        public override System.Web.Mvc.ActionResult RedirectToLocal(string returnUrl, bool addContext)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.RedirectToLocal);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "returnUrl", returnUrl);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "addContext", addContext);
            RedirectToLocalOverride(callInfo, returnUrl, addContext);
            return callInfo;
        }
